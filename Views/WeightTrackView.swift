...
struct WeightTrackView: View
{
    ...
    @State private var addWeight: Bool = false
    
    @Namespace private var animation
    
    var body: some View
    {
        ContentHeaderView(title: "Track Weight",
                          subtitle: "",
                          bar1: Color.pink)
        ...
        VStack(alignment: .leading, spacing: 0, content: {
            ...
            ScrollView(.vertical)
            {
                VStack
                {
                    WeighInView(currentDate: $currentDate)
                }
                .hSpacing(.center)
                .vSpacing(.center)
            }
        ...
        .overlay(alignment: .bottomTrailing, content: {
            Button(action: { addWeight.toggle() }, label: {
        ...
        .sheet(isPresented: $addWeight, content: {
            AddWeightView()
